...
//                 messages.push(
//                   user +
//                     " nice try bad hombre! You still have " +
//                     staleTacos +
//                     " tacos! \n"
//                 );
//               } else {
...
//                 messages.push(
//                   user + " now has a total of " + staleTacos + "! \n"
//                 );
//               }
...
//  * @returns {number}
//  */
// const setTacos = (staleTacos, tacos) =>
//   staleTacos === null ? tacos : parseInt(staleTacos) + parseInt(tacos);
